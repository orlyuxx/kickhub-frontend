    ...
    <>
      ...
      <footer className="footer bg-gray-200 text-primary pt-20 pl-16 pb-6">
        <nav>
          ...
          <a className="link link-hover text-md">KickHub Cebu</a>
          <a className="link link-hover text-md">KickHub Davao</a>
        </nav>
        <nav>
          <h6 className="footer-title font-bold-inter text-primary">Company</h6>
        ...
        <nav>
          <h6 className="footer-title font-bold-inter text-primary">Legal</h6>
      ...
      <footer className="footer bg-gray-200 text-base-content border-base-300 border-t px-10 py-4">
        <aside className="grid-flow-col items-center">
          <Image
            ...
            width={54}
            height={54}
            className="fill-current -pl-10"
          />
          <p className="font-bold-inter text-primary text-md">KickHub Inc.</p>
        </aside>
        <nav className="md:place-self-center md:justify-self-end ml-10">
